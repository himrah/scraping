...
class SC:
	def scrap(self):
		...
		for num in range(1,50):
			...
			data={'mcatName':'Commodities Warehousing Services','mcatId':168815,'catId':344,'searchCity':0,'end':str(nnn),'rand':3,'prod_serv':'S','showkm':0,'debug_mod':0,'biz':0,'price':0,'cntAll':str(nnn+2),'odd':'undefined'}
